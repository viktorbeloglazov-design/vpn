 ...
 *
 * Смахнуть его не выйдет: на Android 14 такое уведомление убирается пальцем,
 * но следующий же круг проверки состояния возвращает его на место — значок
 * обязан быть, пока туннель поднят.
 */
