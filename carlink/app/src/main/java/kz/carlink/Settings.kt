...
enum class Transport {
    /** Провод в машину: она хозяин шины, телефон — аксессуар. */
    USB,

    /** Телефон сам стучится на стенд, запущенный на компьютере. */
    DESK,

    /** Телефон держит порт открытым и ждёт, пока подключатся к нему. */
    WIFI,
}
