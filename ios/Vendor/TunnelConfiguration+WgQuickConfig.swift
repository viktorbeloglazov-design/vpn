...
// (Sources/Shared/Model/TunnelConfiguration+WgQuickConfig.swift, лицензия MIT).
// Разбор файла .conf лежит в приложении Amnezia, а не в библиотеке WireGuardKit,
// поэтому его приходится носить с собой: иначе параметры маскировки
// (Jc, S1, H1 и прочие) читать нечем.
